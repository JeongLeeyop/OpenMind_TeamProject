...
INSERT INTO GYM(CODE, NAME, ADDR, PHONE_NUM, FILE_NAME, GYM_CAPACITY, PRICE, GYM_COMMENT, WEEKDAY_HOUR, WEEKEND_HOUR, STAR_SCORE) 
VALUES(GYM_CODE_SEQ.NEXTVAL, '자마이카휘트니스', '봉천동 862-1 13층', '02-6276-8588', NULL, 20, 300, '새로 오픈해서 쾌적하고 운동하기 좋아요', '10:00-22:00', '06:00-24:00', 4.6);
INSERT INTO GYM(CODE, NAME, ADDR, PHONE_NUM, FILE_NAME, GYM_CAPACITY, PRICE, GYM_COMMENT, WEEKDAY_HOUR, WEEKEND_HOUR, STAR_SCORE) 
VALUES(GYM_CODE_SEQ.NEXTVAL, '리버스휘트니스', '봉천동 관악로 217', '02-885-8628', NULL, 70, 400, '샤워실이 깨끗하고 좋아요', '07:00-22:00', '05:00-24:00', 3.8);
...
INSERT INTO MEMBER (ID, PWD, NAME, PHONE_NUM, GYM_CODE)
VALUES ('QQQ', 'SSS', 'DDD','010-9179-3380', 64); 
...
VALUES(REVIEW_CODE_SEQ.NEXTVAL, 66, 'AAA', SYSDATE, 3, '괜춘', NULL);

--리뷰 목록
SELECT CODE, GYM_CODE, MEMBER_ID, REG_DATE, STAR_SCORE, CONTENT, FILE_NAME FROM REVIEW WHERE GYM_CODE = 66;
...
WHERE MEMBER.ID = 'AAA' AND GYM.CODE = 64;
